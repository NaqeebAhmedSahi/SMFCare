    ...
    <header className="bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden">
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          ...
          >
            Explore our wide selection of precision-engineered surgical
            instruments designed to meet the rigorous standards of healthcare
        ...
        <motion.section
          ...
          className="relative md:px-4 min-h-[448px] md:min-h-[428px] bg-cover bg-top xl:bg-[center_top_-1.6rem] bg-no-repeat bg-[url('/images/header-res-homepage.png')] md:bg-[url('/images/header-homepage.png')] shadow-lg shadow-black rounded-lg overflow-hidden group ml-24 -mt-16 mb-10"
        >
          <div className="w-full h-full bg-cover bg-center transition-transform duration-500 ease-in-out scale-100 group-hover:scale-110">
            <Image
              priority
